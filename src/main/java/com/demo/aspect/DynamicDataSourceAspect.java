...
import com.demo.config.DynamicDataSourceContextHolder;
...
public class DynamicDataSourceAspect {
    ...
    @Pointcut("execution(* com.demo.service.impl.*.get*(..))")
    ...
    public void doBefore(JoinPoint joinPoint, TargetDateSource targetDataSource) {
    ...
    public void doAfter(JoinPoint joinPoint, TargetDateSource targetDataSource) {
    ...
    public void doBeforeWithSlave(JoinPoint joinPoint) {
        ...
        if (null == method.getAnnotation(TargetDateSource.class)) {
